...
#### Usage (This g/gi/gr/gri are same usage like grep, just 'gr' here represents grep -r, and 'gi' represents grep -i, and 'gri' represents grep -ri. All of them are the most common use options)
    g
    gi
    gr 
    gri
